...
namespace test {
		...
		m_TranslationA(200.0f, 200.0f, 0.0f), m_TranslationB(400.0f, 200.0f, 0.0f)
	{
		...
		m_Shader = std::make_unique<Shader>("res/shaders/BasicUniform.shader");
		m_Shader->Bind();
		m_Shader->SetUniform4f("u_Color", 0.2f, 0.5f, 0.7f, 1.0f);

		m_Texture = std::make_unique<Texture>("res/textures/bird.png");
